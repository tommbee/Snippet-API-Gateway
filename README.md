...
Snippet allows you to handle all of your microservicec requests via one URL. Any request body data or URL parameters are included in the proxied request.
